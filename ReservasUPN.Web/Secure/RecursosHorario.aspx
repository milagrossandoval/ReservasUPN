<%@ Page Title="" Language="C#" MasterPageFile="~/Secure/Site.Master" AutoEventWireup="true"
    CodeBehind="RecursosHorario.aspx.cs" Inherits="ReservasUPN.Web.Secure.RecursosHorario" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
<title>Horario Disponible por Recurso</title>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h3 class="page-header">
                    Horario Disponible por Recurso</h3>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-4">
            ...
            <div class="col-lg-4">
                ...
                <asp:CheckBox ID="ChkDefault" runat="server" Text="Grabar como horario por defecto"
                    AutoPostBack="true" OnCheckedChanged="ChkDefault_CheckedChanged" />
                    ...
                    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="Buscar"
                        ...
                        <SelectParameters>
                            ...
                            <asp:ControlParameter ControlID="CmbRecursos" Name="idrecurso" PropertyName="SelectedValue"
                                Type="Int32" />
                            <asp:ControlParameter ControlID="ChkDefault" Name="defecto" PropertyName="Checked"
                                Type="Boolean" />
                        </SelectParameters>
                    </asp:ObjectDataSource>
                </div>
    ...
    <telerik:RadWindow ID="WinConfirmacion" runat="server" Title="Correcto" EnableTheming="false"
        Skin="Windows7" VisibleOnPageLoad="false" Modal="true" Width="350" Height="200"
        BorderStyle="None" Behaviors="None">
        <ContentTemplate>
            <center>
                <b>Se registró correctamente el horario para el tipo de recurso:
                    <%= CmbTiposRecurso.Text %>. </b>
                <br />
