<%@ Page Title="" Language="C#" MasterPageFile="~/Secure/Site.Master" AutoEventWireup="true"
    CodeBehind="ReservarUsuario.aspx.cs" Inherits="ReservasUPN.Web.Secure.ReservarUsuario" %>
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    ...
                                    <telerik:RadComboBox ID="CmbRecursos" runat="server" AutoPostBack="True" Width="200px"
                                        CausesValidation="false" DataValueField="id" DataTextField="descripcion" DataSourceID="OdsRecurso"
                                        OnDataBound="CmbRecursos_DataBound" OnSelectedIndexChanged="CmbRecursos_SelectedIndexChanged" />
